...
**Code not usable outside the authors' environment** (requires the cloning of 
the CTV R forge repository).
...
Next update of the taskview should check for the inclusion of `eimpute`, `mifa`,
`miselect`, `missMethods`, `RfEmpImp`, `rMIDAS`, `rMisbeta`, `PKLM`.
